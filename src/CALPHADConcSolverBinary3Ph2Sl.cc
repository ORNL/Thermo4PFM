    ...
    const double* const c, double* const fvec)
{
    ...
    fvec[1] = q_[0] * (xlogx_deriv(ypp_A[0]) - xlogx_deriv(1. - ypp_A[0]))
              ...
              + (xi[0] - xi[1]);
    fvec[2] = q_[1] * (xlogx_deriv(c[1]) - xlogx_deriv(1. - ypp_A[1]))
    ...
    const double* const c, JacobianDataType** const fjac)
{
    ...
    fjac[1][0]
        = (p_[0] + q_[0])
          * (dxidc[0] + xlogx_deriv2(ypp_A[0]) + xlogx_deriv2(1. - ypp_A[0]));
    fjac[1][1]
        = (p_[1] + q_[1])
          * (-dxidc[1] - xlogx_deriv2(ypp_A[1]) - xlogx_deriv2(1. - ypp_A[1]));
    fjac[1][2] = 0.;
    ...
    fjac[2][2]
        = (p_[2] + q_[2])
          * (-dxidc[2] - xlogx_deriv2(ypp_A[2]) - xlogx_deriv2(1. - ypp_A[2]));
}
